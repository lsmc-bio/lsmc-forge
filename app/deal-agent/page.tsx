    ...
    <main className="flex h-screen flex-col bg-lsmc-night">
      ...
      <header className="flex items-center gap-4 border-b border-lsmc-steel/30 px-6 py-4">
        ...
        <button
          ...
          className="ml-auto flex items-center gap-2 rounded-lg border border-lsmc-accent/40 bg-lsmc-accent/5 px-4 py-2 text-xs font-semibold text-lsmc-glow transition-all hover:border-lsmc-accent/60 hover:bg-lsmc-accent/10 hover:text-lsmc-white"
        >
