...
import type { PlatformConfig } from "./pricing";
...
export const PRODUCT_PRESETS: ProductPreset[] = [
  {
    ...
    platformConfig: "ug_hybrid",
    consumableKey: "UG_S4_FLOWCELL",
  ...
  },
  {
    ...
    platformConfig: "ilmn_only",
    consumableKey: "NOVASEQ_25B_FLOWCELL",
  ...
  },
  {
    ...
    longRead: { platform: "none", depth: "N/A" },
    platformConfig: "ug_only",
    consumableKey: "UG_S2_FLOWCELL",
